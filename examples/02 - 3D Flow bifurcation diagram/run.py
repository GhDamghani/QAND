...
f = Main.eval(open('func.jl', 'r').read())
...
p = [1.54]
n = 500
p_array = linspace(1.52, 1.5538, n, 1)
...
if bif_file not in current_files:
    ...
    bif = sys1.bifurcation(0, p, p_array, u0, tspan, mode='min', transient=100, u0_forward=True, tqdm=True, num_points=500)
    bif.save(bif_file)
else:
